...
public class TeamUtil {
        ...
        public enum TeamName {
                CELTICS(2, "Celtics", "BOS", "Boston", "boston-celtics"),
                NETS(3, "Nets", "BKN", "Brooklyn", "brooklyn-nets"),
                ...
                TeamName(final int id, final String name, final String shortName, final String city,
                                final String espnUrlCode) {
                        tId = id;
                        tName = name;
        ...
        public static Map<TeamName, Team> generateTeamMap()
                ...
                Gson gson = new Gson();
                Games[] gamesArray = gson.fromJson(gamesJoArr.toString(), Games[].class); // populate Game objects from
                                                                                          // array
                ...
                System.out.println("iterated all games and populated map: " + (System.nanoTime() - start) / 1000000
                                + "ms");
                ...
                for (int i = 0; i < numTeams; i++) {
                        ...
                        Team team = new Team.Builder(TeamUtil.TeamName.getById(teamId))
                                        ...
                                        .seasonAvgPf(Math.round((double) totalTeamStatsMap.get(teamId).get("seasonPpg")
                                                        / (int) totalTeamStatsMap.get(teamId).get("gamesPlayed") * 10)
                                                        / 10.0)
                                        ...
                                        .last5PF(Math.round(
                                                        (double) totalTeamStatsMap.get(teamId).get("last5Pf") / 5 * 10)
                                                        / 10.0)
                                        .last5PA(Math.round(
                                                        (double) totalTeamStatsMap.get(teamId).get("last5Pa") / 5 * 10)
                                                        / 10.0)
                                        .last10PF(Math.round((double) totalTeamStatsMap.get(teamId).get("last10Pf"))
                                                        / 10.0)
                                        .last10PA(Math.round((double) totalTeamStatsMap.get(teamId).get("last10Pa"))
                                                        / 10.0)
                                        .last5Over500Pf(
                                                        Math.round((double) totalTeamStatsMap.get(teamId)
                                                                        .get("last5Over500Pf") / 5 * 10) / 10.0)
                                        .last5Over500Pa(
                                                        Math.round((double) totalTeamStatsMap.get(teamId)
                                                                        .get("last5Over500Pa") / 5 * 10) / 10.0)
                                        .last5Under500Pf(
                                                        Math.round((double) totalTeamStatsMap.get(teamId)
                                                                        .get("last5Under500Pf") / 5 * 10) / 10.0)
                                        .last5Under500Pa(
                                                        Math.round((double) totalTeamStatsMap.get(teamId)
                                                                        .get("last5Under500Pa") / 5 * 10) / 10.0)
                                        .last10Over500Pf(Math.round(
                                                        (double) totalTeamStatsMap.get(teamId).get("last10Over500Pf"))
                                                        / 10.0)
                                        .last10Over500Pa(Math.round(
                                                        (double) totalTeamStatsMap.get(teamId).get("last10Over500Pa"))
                                                        / 10.0)
                                        .last10Under500Pf(Math.round(
                                                        (double) totalTeamStatsMap.get(teamId).get("last10Under500Pf"))
                                                        / 10.0)
                                        .last10Under500Pa(Math.round(
                                                        (double) totalTeamStatsMap.get(teamId).get("last10Under500Pa"))
                                                        / 10.0)
                                        ...
                                        .last2AwayPa(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last2AwayPa")
                                                                        / 2 * 10)
                                                        / 10.0)
                                        .last2AwayPf(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last2AwayPf")
                                                                        / 2 * 10)
                                                        / 10.0)
                                        .last5AwayPf(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last5AwayPf")
                                                                        / 5 * 10)
                                                        / 10.0)
                                        .last5AwayPa(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last5AwayPa")
                                                                        / 5 * 10)
                                                        / 10.0)
                                        .last2HomePa(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last2HomePa")
                                                                        / 2 * 10)
                                                        / 10.0)
                                        .last2HomePf(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last2HomePf")
                                                                        / 2 * 10)
                                                        / 10.0)
                                        .last5HomePf(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last5HomePf")
                                                                        / 5 * 10)
                                                        / 10.0)
                                        .last5HomePa(Math
                                                        .round((double) totalTeamStatsMap.get(teamId).get("last5HomePa")
                                                                        / 5 * 10)
                                                        / 10.0)
                                        .isHotStreak((int) totalTeamStatsMap.get(teamId)
                                                        .get("winStreak") > STREAK_GAMES)
                                        .isColdStreak((int) totalTeamStatsMap.get(teamId)
                                                        .get("loseStreak") > STREAK_GAMES)
                                        .isHomeColdStreak((int) totalTeamStatsMap.get(teamId)
                                                        .get("homeLoseStreak") > STREAK_GAMES)
                                        .isHomeHotStreak((int) totalTeamStatsMap.get(teamId)
                                                        .get("homeWinStreak") > STREAK_GAMES)
                                        .isAwayColdStreak((int) totalTeamStatsMap.get(teamId)
                                                        .get("awayLoseStreak") > STREAK_GAMES)
                                        .isAwayHotStreak((int) totalTeamStatsMap.get(teamId)
                                                        .get("awayWinStreak") > STREAK_GAMES)
                ...
                for (Team curTeam : teamMap.values()) {
                        ...
                        curTeam.setNormalizedLastPf(
                                        getNormalizedScore(curTeam.getLastPF(), lastTeamDefRank, defensiveRankings,
                                                        true));
                        curTeam.setNormalizedLastPa(
                                        getNormalizedScore(curTeam.getLastPA(), lastTeamOffRank, offensiveRankings,
                                                        false));

                        // if we reached our cap of 5 teams, divide by 5, otherwise divide by the last
                        // known number of teams
                        curTeam.setLast5OppORank(
                                        validTeamIdx >= 5 ? last5TeamOffRank / 5 : last5TeamOffRank / validTeamIdx);
                        curTeam.setLast5OppDRank(
                                        validTeamIdx >= 5 ? last5TeamDefRank / 5 : last5TeamDefRank / validTeamIdx);
                        curTeam.setNormalizedLast5Pf(
                                        getNormalizedScore(curTeam.getLast5PF(), curTeam.getLast5OppDRank(),
                                                        defensiveRankings, true));
                        curTeam.setNormalizedLast5Pa(
                                        getNormalizedScore(curTeam.getLast5PA(), curTeam.getLast5OppORank(),
                                                        offensiveRankings, false));

                        curTeam.setLast10OppORank(
                                        validTeamIdx >= 10 ? last10TeamOffRank / 10 : last10TeamOffRank / validTeamIdx);
                        curTeam.setLast10OppDRank(
                                        validTeamIdx >= 10 ? last10TeamDefRank / 10 : last10TeamDefRank / validTeamIdx);
                        curTeam.setNormalizedLast10Pf(
                                        getNormalizedScore(curTeam.getLast10PF(), curTeam.getLast10OppDRank(),
                                                        defensiveRankings, true));
                        curTeam.setNormalizedLast10Pa(
                                        getNormalizedScore(curTeam.getLast10PA(), curTeam.getLast10OppORank(),
                                                        offensiveRankings, false));

                        curTeam.setLast2AwayOppORank(
                                        validAwayTeamIdx >= 2 ? last2AwayOppOffRank / 2
                                                        : last2AwayOppOffRank / validAwayTeamIdx);
                        curTeam.setLast2AwayOppDRank(
                                        validAwayTeamIdx >= 2 ? last2AwayOppDefRank / 2
                                                        : last2AwayOppDefRank / validAwayTeamIdx);
                        curTeam.setNormalizedLast2AwayPf(
                                        getNormalizedScore(curTeam.getLast2AwayPf(), curTeam.getLast2AwayOppDRank(),
                                                        defensiveRankings,
                                                        true));
                        curTeam.setNormalizedLast2AwayPa(
                                        getNormalizedScore(curTeam.getLast2AwayPa(), curTeam.getLast2AwayOppORank(),
                                                        offensiveRankings,
                                                        false));

                        curTeam.setLast5AwayOppORank(
                                        validAwayTeamIdx >= 5 ? last5AwayOppOffRank / 5
                                                        : last5AwayOppOffRank / validAwayTeamIdx);
                        curTeam.setLast5AwayOppDRank(
                                        validAwayTeamIdx >= 5 ? last5AwayOppDefRank / 5
                                                        : last5AwayOppDefRank / validAwayTeamIdx);
                        curTeam.setNormalizedLast5AwayPf(
                                        getNormalizedScore(curTeam.getLast5AwayPf(), curTeam.getLast5AwayOppDRank(),
                                                        defensiveRankings,
                                                        true));
                        curTeam.setNormalizedLast5AwayPa(
                                        getNormalizedScore(curTeam.getLast5AwayPa(), curTeam.getLast5AwayOppORank(),
                                                        offensiveRankings,
                                                        false));

                        curTeam.setLast2HomeOppORank(
                                        validHomeTeamIdx >= 2 ? last2HomeOppOffRank / 2
                                                        : last2HomeOppOffRank / validHomeTeamIdx);
                        curTeam.setLast2HomeOppDRank(
                                        validHomeTeamIdx >= 2 ? last2HomeOppDefRank / 2
                                                        : last2HomeOppDefRank / validHomeTeamIdx);

                        curTeam.setNormalizedLast2HomePf(
                                        getNormalizedScore(curTeam.getLast2HomePf(), curTeam.getLast2HomeOppDRank(),
                                                        defensiveRankings,
                                                        true));
                        curTeam.setNormalizedLast2HomePa(
                                        getNormalizedScore(curTeam.getLast2HomePa(), curTeam.getLast2HomeOppORank(),
                                                        offensiveRankings,
                                                        false));

                        curTeam.setLast5HomeOppORank(
                                        validHomeTeamIdx >= 5 ? last5HomeOppOffRank / 5
                                                        : last5HomeOppOffRank / validHomeTeamIdx);
                        curTeam.setLast5HomeOppDRank(
                                        validHomeTeamIdx >= 5 ? last5HomeOppDefRank / 5
                                                        : last5HomeOppDefRank / validHomeTeamIdx);

                        curTeam.setNormalizedLast5HomePf(
                                        getNormalizedScore(curTeam.getLast5HomePf(), curTeam.getLast5HomeOppDRank(),
                                                        defensiveRankings,
                                                        true));
                        curTeam.setNormalizedLast5HomePa(
                                        getNormalizedScore(curTeam.getLast5HomePa(), curTeam.getLast5HomeOppORank(),
                                                        offensiveRankings,
                                                        false));
                }
        ...
        private static double getNormalizedScore(double score, double oppRank, List<Double> rankings, boolean pf) {
                ...
                double rankDifferential = Math.abs(15 - oppRank) * pointPerRank * multiplier; // get points to add or
                                                                                              // sub
                ...
                for (Games game : gamesArray) {
                        ...
                        for (int i = 0; i < 2; i++) { // iterate over the two teams in the game
                                ...
                                double seasonOppg = teamMap.get(teamId) != null
                                                ...
                                                : 0;
                                int gamesPlayed = teamMap.get(teamId) != null
                                                ? (int) teamMap.get(teamId).get("gamesPlayed")
                                                : 0;
                                ...
                                long daysRested = teamMap.get(teamId) != null
                                                ? (long) teamMap.get(teamId).get("daysRested")
                                                : -1;
                                double last5Pf = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last5Pf")
                                                : 0;
                                double last5Pa = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last5Pa")
                                                : 0;
                                double last10Pf = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last10Pf")
                                                : 0;
                                double last10Pa = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last10Pa")
                                                : 0;
                                ...
                                double last5Under500Pa = teamMap.get(teamId) != null
                                                ...
                                                : 0;
                                double last2HomePf = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last2HomePf")
                                                : 0;
                                double last2HomePa = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last2HomePa")
                                                : 0;
                                double last5HomePf = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last5HomePf")
                                                : 0;
                                double last5HomePa = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last5HomePa")
                                                : 0;
                                double last2AwayPf = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last2AwayPf")
                                                : 0;
                                double last5AwayPf = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last5AwayPf")
                                                : 0;
                                double last2AwayPa = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last2AwayPa")
                                                : 0;
                                double last5AwayPa = teamMap.get(teamId) != null
                                                ? (double) teamMap.get(teamId).get("last5AwayPa")
                                                : 0;
                                int winStreak = teamMap.get(teamId) != null ? (int) teamMap.get(teamId).get("winStreak")
                                                : 0;
                                int loseStreak = teamMap.get(teamId) != null
                                                ? (int) teamMap.get(teamId).get("loseStreak")
                                                : 0;
                                int homeWinStreak = teamMap.get(teamId) != null
                                                ? (int) teamMap.get(teamId).get("homeWinStreak")
                                                : 0;
                                int homeLoseStreak = teamMap.get(teamId) != null
                                                ? (int) teamMap.get(teamId).get("homeLoseStreak")
                                                : 0;
                                int awayWinStreak = teamMap.get(teamId) != null
                                                ? (int) teamMap.get(teamId).get("awayWinStreak")
                                                : 0;
                                int awayLoseStreak = teamMap.get(teamId) != null
                                                ? (int) teamMap.get(teamId).get("awayLoseStreak")
                                                : 0;
                                int totalWins = teamMap.get(teamId) != null ? (int) teamMap.get(teamId).get("totalWins")
                                                : 0;
                                int totalLoss = teamMap.get(teamId) != null ? (int) teamMap.get(teamId).get("totalLoss")
                                                : 0;
                                int totalOppWins = teamMap.get(oppId) != null
                                                ? (int) teamMap.get(oppId).get("totalWins")
                                                : 0;
                                int totalOppLosses = teamMap.get(oppId) != null
                                                ? (int) teamMap.get(oppId).get("totalLoss")
                                                : 0;
                                ...
                                int[] last5AwayTeamsPlayedArr = teamMap.get(teamId) != null
                                                ...
                                                : new int[] { -1, -1, -1, -1, -1 };
                                String lastGameInfo = teamMap.get(teamId) != null
                                                ? (String) teamMap.get(teamId).get("lastGameInfo")
                                                : "";
                                String nextGameInfo = teamMap.get(teamId) != null
                                                ? (String) teamMap.get(teamId).get("nextGameInfo")
                                                : "";
                                ...
                                if (0 == game.getPeriod() && "".equals(nextGameInfo)
                                                && !postponedGames.contains(game.getId())) {
                                        nextGameHomeTeam = game.getHome_team().getId() == teamId;

                                        nextGameInfo = "The next game is " + game.getVisitor_team().getFull_name()
                                                        + " at "
                                ...
                                if ("Final".equals(game.getStatus())) {
                                        gamesPlayed++;
                                        seasonPpg += isHomeTeam ? game.getHome_team_score()
                                                        : game.getVisitor_team_score();
                                        seasonOppg += isHomeTeam ? game.getVisitor_team_score()
                                        ...
                                        for (int idx = 0; idx <= 9; idx++) {
                                                if (idx <= 8) {
                                                        last10GamesPfArr[idx] = last10GamesPfArr[(idx + 1)]; // shift
                                                                                                             // last 10
                                                                                                             // games
                                                                                                             // leftward
                                                        ...
                                                        if (isOppOver500) { // opponent over .500 win
                                                                ...
                                                                last10TeamsOver500Arr[idx] = last10TeamsOver500Arr[(idx
                                                                                + 1)];
                                                        } else { // .500 or less
                                                                last10Under500PaArr[idx] = last10Under500PaArr[(idx
                                                                                + 1)];
                                                                last10Under500PfArr[idx] = last10Under500PfArr[(idx
                                                                                + 1)];
                                                                last10TeamsUnder500Arr[idx] = last10TeamsUnder500Arr[(idx
                                                                                + 1)];
                                                        }
                                                } else {// the last spot in the array, set to most recent game.
                                                        last10GamesPfArr[idx] = isHomeTeam ? game.getHome_team_score()
                                                                        : game.getVisitor_team_score();
                                                        last10GamesPaArr[idx] = isHomeTeam
                                                                        ? game.getVisitor_team_score()
                                                                        : game.getHome_team_score();
                                                        last10TeamsPlayedArr[idx] = isHomeTeam
                                                                        ? game.getVisitor_team().getId()
                                                                        : game.getHome_team().getId();
                                                        if (isOppOver500) { // opponent over .500 win
                                                                last10Over500PfArr[idx] = isHomeTeam
                                                                                ? game.getHome_team_score()
                                                                                : game.getVisitor_team_score();
                                                                last10Over500PaArr[idx] = isHomeTeam
                                                                                ? game.getVisitor_team_score()
                                                                                : game.getHome_team_score();
                                                                last10TeamsOver500Arr[idx] = isHomeTeam
                                                                                ? game.getVisitor_team().getId()
                                                                                : game.getHome_team().getId();
                                                        } else { // .500 or less
                                                                last10Under500PaArr[idx] = isHomeTeam
                                                                                ? game.getVisitor_team_score()
                                                                                : game.getHome_team_score();
                                                                last10Under500PfArr[idx] = isHomeTeam
                                                                                ? game.getHome_team_score()
                                                                                : game.getVisitor_team_score();
                                                                last10TeamsUnder500Arr[idx] = isHomeTeam
                                                                                ? game.getVisitor_team().getId()
                                                                                : game.getHome_team().getId();
                                                        }
                                                }
                                        ...
                                        for (int idx = 0; idx <= 4; idx++) {
                                                if (idx <= 3) {
                                                        if (isHomeTeam) {
                                                                last5HomeGamesPfArr[idx] = last5HomeGamesPfArr[(idx
                                                                                + 1)]; // shift last 5 games
                                                                last5HomeGamesPaArr[idx] = last5HomeGamesPaArr[(idx
                                                                                + 1)];
                                                                last5HomeTeamsPlayedArr[idx] = last5HomeTeamsPlayedArr[(idx
                                                                                + 1)];
                                                        } else {
                                                                last5AwayGamesPfArr[idx] = last5AwayGamesPfArr[(idx
                                                                                + 1)]; // shift last 5 games
                                                                last5AwayGamesPaArr[idx] = last5AwayGamesPaArr[(idx
                                                                                + 1)];
                                                                last5AwayTeamsPlayedArr[idx] = last5AwayTeamsPlayedArr[(idx
                                                                                + 1)];
                                                        }
                                                } else {// the last spot in the array, set to most recent game.
                                                        if (isHomeTeam) {
                                        ...
                                        if (isHomeTeam) {
                                                lastGameInfo += game.getHome_team_score() > game.getVisitor_team_score()
                                                                ? " W"
                                                                : " L";
                                                lastGameInfo += game.getHome_team_score() + " - "
                                                                + game.getVisitor_team_score();
                                        } else {
                                                lastGameInfo += game.getHome_team_score() < game.getVisitor_team_score()
                                                                ? " W"
                                                                : " L";
                                                lastGameInfo += game.getVisitor_team_score() + " - "
                                                                + game.getHome_team_score();
                                        }
                                        ...
                                        daysRested = TimeUnit.MILLISECONDS
                                                        .toDays(today.getTimeInMillis() - lastGame.getTimeInMillis())
                                                        - 1;
                                        // End Last Game
                                }
